...
class Hydrodynamics:
    ...
    def ComputeHydroDampingMatrix(self, vel):
        """
    ...
    def ComputeHydrodynamicsEffects(self, quaternions, world_vel, positions_z):
        # Debug
        ...
        damping_matrix = self.ComputeHydroDampingMatrix(self.local_velocities)
        # Debug
        ...
        # hydrodynamics only applies when only the robot is underwater.
