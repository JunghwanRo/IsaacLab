...
class SealMigrationEnvCfg(SealEnvCfg):
    ...
    def __init__(self, **kwargs):
        ...
        self.crash_reward_scale = -10.0  # default -5.0
...
class SealMigrationEnv(SealEnv):
    ...
    def __init__(self, cfg: SealEnvCfg, render_mode: str | None = None, **kwargs):
        ...
        # Initialize prev distance and action values
    ...
    def _get_observations(self) -> dict:
        ...
        obs = torch.cat(
            [
                ...
                joint_vel_obs,
                desired_pos_b,
                self._prev_discrete_cmd.unsqueeze(-1),
    ...
    def _get_rewards(self) -> torch.Tensor:
        ...
        # Update the prev distance to goal
    ...
    def _get_dones(self) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        out_of_bound = torch.logical_or(self._robot.data.root_pos_w[:, 2] < -10.0, self._robot.data.root_pos_w[:, 2] > 20.0)
        goal_reached = torch.logical_and(self.distance_to_goal > 0.0, self.distance_to_goal < 2.5)
